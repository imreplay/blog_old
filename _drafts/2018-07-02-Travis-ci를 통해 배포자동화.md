...
왼쪽 상단에 `Branch: master` 부분을 클릭합니다

`Find or create a branch...` 라는 부분이 보인다면 `gh-pages` 를 입력하고 엔터!

짠! gh-pages 브랜치가 생성되었습니다!
...
## 마치며
새로운 저장소를 만들고 한번더 `theme`와 `travis-ci`를 연동시켜보니 어느정도 흐름이 보이는 것 같습니다
